...
class Category extends Controller
{
     ...
     * @var string
     */
    protected $table = 'TpGoodsCategory';
    ...
    protected function _index_page_filter(array &$data)
    {
        ...
        foreach ($data as &$vo) {
            ...
            $vo['ids'] = join(',', DataExtend::getArrSubIds($data, $vo['id'], 'id', 'parent_id'));
        }
        $data = DataExtend::arr2table($data, 'id', 'parent_id', 'parent_id_path');
