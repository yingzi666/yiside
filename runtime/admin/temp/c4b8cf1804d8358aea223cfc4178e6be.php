<?php /*a:2:{s:62:"/Users/zhangboshuai/www/yiside/app/admin/view/stock/apply.html";i:1602740831;s:55:"/Users/zhangboshuai/www/yiside/app/admin/view/main.html";i:1603166068;}*/ ?>
<div class="layui-card layui-bg-gray"><link href="/public/static/plugs/ztree/zTreeStyle/zTreeStyle.css" rel="stylesheet"><script src="/public/static/plugs/ztree/ztree.all.min.js"></script><style>
    ul.ztree li {
    ...
    window.RoleAction = new function () {
        ...
        this.getData = function (that, index) {
            index = $.msg.loading();
            $.form.load('<?php echo url("apply"); ?>', {id: '<?php echo htmlentities($vo['id']); ?>', action: 'get'}, 'post', function (ret) {
        ...
        this.submit = function () {
            ...
            $.form.load('<?php echo url("apply"); ?>', {id: '<?php echo htmlentities($vo['id']); ?>', action: 'save', nodes: nodes}, 'post');
        };
        // 刷新数据
        this.getData(this);
        // 提交表单
